...
# Find the insertion point (after /admin/summary route)
insertion_marker = "  return res.status(200).json({ summary: out })\n})\n"
...
new_content = content[:insertion_point] + new_routes + content[insertion_point:]

# Write back
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Successfully added missing routes to server.js")
